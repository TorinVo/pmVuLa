    ...
    <div class="wrapper" id="app">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="{{asset('img/system/logo.png')}}" alt="..." class="brand-image img-circle elevation-3"
                    style="opacity: .8">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ (Auth::user()->photo) ? asset('img/profile/'.Auth::user()->photo) : asset('img/avatar.png') }}" class="img-circle elevation-2" alt="...">
                    </div>
                    <div class="info">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <router-link :to="{ name: 'events' }" class="nav-link" :class="{ 'active': navSelect === 'events' }">
